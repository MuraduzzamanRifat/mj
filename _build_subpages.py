...
<nav class="nav" id="nav">
  <div class="nav-inner">
    ...
    <div class="nav-right">
      <a href="{up}muraduzzaman-cv-portfolio.pdf" class="nav-pdf" download="muraduzzaman-cv-portfolio.pdf" aria-label="Download CV as PDF">
...
<div class="nav-mobile" id="navMobile" aria-hidden="true">
  ...
  <div class="nav-mobile-foot">
    <a href="{up}muraduzzaman-cv-portfolio.pdf" download="muraduzzaman-cv-portfolio.pdf">Download CV (PDF)</a>
    ...
    <div class="sf-top">
      ...
      <div class="sf-col">
        ...
        <ul>
          ...
          <li><a href="{up}muraduzzaman-cv-portfolio.pdf" download>Download CV</a></li>
        </ul>
      </div>
    </div>
    <div class="sf-bottom">
...
<main id="main" class="sub-body">
  <div class="wrap">
    ...
    <p class="cv-hint reveal" style="max-width:760px;margin-bottom:60px;">
      Three-page dark CV designed to match this site. If you need a plain-text version for an ATS parser, <a href="#contact-form">ask in the form</a> and I'll send one.
    </p>
